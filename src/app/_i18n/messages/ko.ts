...
export const ko: Messages = {
  ...
  "settings.section.service": "브랜드, 주소, Artifact 전달, 동시 실행과 메시징을 설정한다.",
  "settings.section.access": "관리자와 허용 이메일 도메인을 설정한다.",
  "settings.section.plugins": "Plugin 동기화에 사용할 저장소, 브랜치와 GitHub 토큰을 설정한다.",
  "settings.field.serviceName": "서비스 이름",
  "settings.hint.serviceName": "콘솔, 페이지 제목과 연동 설명에 표시한다.",
  "settings.field.serviceLogo": "서비스 로고",
  "settings.hint.serviceLogo": "이 배포에 자산이 포함된 브랜드를 선택한다.",
  ...
  "settings.hint.s3PublicUrl": "독자가 프록시를 통해 오브젝트 스토리지에 접근할 때 공개 Artifact 링크에 사용한다.",
  "settings.field.slackLoading": "Slack 로딩 표시",
  "settings.hint.slackLoading": "Slack 답변을 수정하며 작성하는 동안 표시한다.",
  ...
  "modelAdmin.selectionHint": "등록한 프로바이더에서 Model을 조회하고 이 설치에서 사용할 Model을 등록한다.",
  "modelAdmin.usage": "Model 사용 설정",
  "modelAdmin.usageHint": "기본·결정·Workspace·검색 Model과 실행 정책을 설정한다.",
  ...
  "modelAdmin.factsHint": "공개 Provider의 모델과 가격은 models.opspresso.com에서, 내부 self-hosted 모델은 해당 엔드포인트에서 조회한다. 오프라인에서는 내장 카탈로그를 사용한다.",
  ...
  "models.sortPriceHint": "Text는 출력 토큰, Embedding·Decision은 입력 토큰 가격을 기준으로 정렬한다. 이미지·오디오·Rerank는 제공된 단위 가격을 사용하며, 가격 미지정 모델은 마지막에 표시한다.",
