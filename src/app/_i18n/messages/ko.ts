...
export const ko: Messages = {
  ...
  "settings.section.service": "서비스 주소, Artifact 접근 방식과 모델 가격 정책을 설정한다.",
  ...
  "settings.field.catalogMinScore": "Capability 검색 최소 점수",
  "settings.hint.catalogMinScore": "절대 벡터 점수 하한을 0~1로 설정한다. Embedding Model을 바꾸면 다시 확인한다.",
  ...
  "settings.group.execution": "실행과 검색",
