...
export const ko: Messages = {
  ...
  "secrets.resetHint": "저장하면 배포 환경변수 값을 사용합니다.",
  "secrets.visibleHint": "실제 인증 값입니다. 사용할 클라이언트에만 전달하세요.",
  "secrets.show": "보기",
  "secrets.hide": "숨기기",
  "secrets.generate": "생성",
  ...
  "secrets.regenerateHint": "기존 키는 즉시 사용할 수 없게 됩니다. 이 키를 사용하는 모든 클라이언트를 갱신해야 합니다.",
  "secrets.revokeTitle": "{name}을(를) 폐기할까요?",
  "secrets.revokeHint": "이 키를 사용하는 요청을 더 이상 인증하지 않습니다.",
  "secrets.legacyHint": "이전 방식으로 저장된 토큰은 다시 볼 수 없습니다. 재생성하면 조회 가능한 토큰으로 바뀝니다.",
  "secrets.createdAt": "생성일 {date}",
  "secrets.agentTokenHint": "이 Agent의 API로 들어오는 외부 요청을 인증합니다. 사용량은 이 토큰과 Agent에 기록합니다.",
  ...
  "integrations.notConnected": "연결되지 않음",
  "settings.noResults": "검색 조건에 맞는 Model이 없습니다.",
  "settings.tab.service": "Service",
  "settings.tab.access": "Access",
  "settings.tab.plugins": "Plugins",
  "settings.tab.models": "Models",
  "settings.models.registered": "등록 모델 관리",
  "settings.models.registeredHint": "선택한 Model을 수정하고 프로바이더 상태를 확인하거나 사용하지 않는 Model을 삭제합니다.",
  "settings.section.service": "브랜드, 주소, Artifact 전달, 동시 실행과 메시징을 설정합니다.",
  "settings.section.access": "관리자와 허용 이메일 도메인을 설정합니다.",
  "settings.section.plugins": "Plugin 동기화에 사용할 저장소, 브랜치와 GitHub 토큰을 설정합니다.",
  "settings.field.serviceName": "서비스 이름",
  "settings.hint.serviceName": "콘솔, 페이지 제목과 연동 설명에 표시합니다.",
  "settings.field.serviceLogo": "서비스 로고",
  "settings.hint.serviceLogo": "이 배포에 자산이 포함된 브랜드를 선택하세요.",
  "settings.field.maxConcurrentRuns": "호출자별 동시 실행",
  "settings.hint.maxConcurrentRuns": "호출자 한 명의 동시 실행 수를 제한한다(0은 제한 없음, 최대 1000).",
  "settings.field.s3PublicUrl": "공개 오브젝트 주소",
  "settings.hint.s3PublicUrl": "독자가 프록시를 통해 오브젝트 스토리지에 접근할 때 공개 Artifact 링크에 사용합니다.",
  "settings.field.slackLoading": "Slack 로딩 표시",
  "settings.hint.slackLoading": "Slack 답변을 수정하며 작성하는 동안 표시합니다.",
  "settings.group.branding": "브랜드",
  "settings.group.delivery": "주소와 Artifact",
  "settings.group.execution": "실행 한도",
  "settings.group.messaging": "메시징",
  "settings.group.pluginSource": "Plugin 소스",
  "settings.group.pluginCredentials": "GitHub 인증",
  "settings.field.publicUrl": "서비스 공개 주소",
  "settings.hint.publicUrl": "사용자와 연동 서비스가 이 설치에 접근할 때 사용하는 HTTPS 주소입니다.",
  "settings.field.artifactAccess": "Artifact 접근 방식",
  "settings.hint.artifactAccess": "생성 파일을 사용자에게 전달하는 방식을 선택하세요.",
  "settings.field.adminEmails": "관리자 이메일",
  "settings.hint.adminEmails": "Enter 또는 쉼표로 이메일을 추가하세요. 목록을 변경할 때 자신의 주소를 포함하세요.",
  "settings.field.emailDomains": "허용 이메일 도메인",
  "settings.hint.emailDomains": "@ 없이 example.com과 같은 도메인을 추가하세요.",
  "settings.field.pluginRepo": "Plugin 저장소",
  "settings.hint.pluginRepo": "owner/repository 형식으로 입력하세요. 인증이 필요한 동기화에는 토큰을 설정하세요.",
  "settings.field.pluginBranch": "저장소 브랜치",
  "settings.field.githubToken": "GitHub 토큰",
  "settings.hint.githubToken": "Plugin 동기화와 설정된 GitHub 작업에 사용합니다. 교체하려면 새 토큰을 입력하세요.",
  "settings.source.override": "저장 설정",
  "settings.source.env": "환경변수",
  "settings.source.default": "기본값",
  "settings.source.unset": "미설정",
  "settings.overrideHint": "변경한 항목만 저장합니다. 저장값을 비우면 환경변수 값을 사용합니다. 변경하지 않은 마스킹된 키는 유지합니다.",
  ...
  "modelAdmin.providerHint": "프로바이더와 사내 Model 서버의 연결을 등록합니다.",
  "modelAdmin.selection": "Model 조회·등록",
  "modelAdmin.selectionHint": "등록한 프로바이더에서 Model을 조회하고 이 설치에서 사용할 Model을 등록합니다.",
  "modelAdmin.usage": "Model 사용 설정",
  "modelAdmin.usageHint": "기본·결정·Workspace·검색 Model과 실행 정책을 설정합니다.",
  "modelAdmin.primaryModels": "기본 및 결정 Model",
  "modelAdmin.executionPolicy": "Model 실행 정책",
  "modelAdmin.policyFailed": "Model 정책을 저장하지 못했습니다",
  "configuration.group.response": "응답 설정",
  "configuration.group.policy": "안전 및 출력 정책",
  "configuration.group.builtins": "내장 기능",
  "configuration.group.bindings": "연결과 기능 검색",
  "modelAdmin.decision": "결정 Model (Agent 추천·모델 라우팅)",
  ...
  "modelAdmin.keyHint": "비워 두면 저장된 키를 유지합니다. 주소를 변경하면 새 키가 필요합니다. Self-hosted 연결은 키를 생략할 수 있습니다.",
  "modelAdmin.save": "저장",
  "modelAdmin.saved": "저장됨",
  "modelAdmin.edit": "수정",
  "modelAdmin.delete": "삭제",
  "modelAdmin.deleteProvider": "프로바이더를 삭제할까요?",
  "modelAdmin.deleteProviderHint": "이 연결을 삭제합니다. 연결에 등록한 Model을 먼저 삭제해야 합니다.",
  "modelAdmin.emptyProviders": "Model을 조회하려면 프로바이더를 등록하세요.",
  ...
  "modelAdmin.unknownLimits": "0은 프로바이더가 한도를 제공하지 않았음을 뜻합니다. 사용 전에 한도와 기능을 확인하세요.",
  ...
  "settings.hint.unknownModelPolicy": "등록된 모델의 가격이 미지정일 때 실행을 허용할지 정합니다. 미등록 모델은 항상 거부합니다.",
  "settings.unknownModelPolicy.allow": "실행 허용 및 비용 누락 표시",
  "settings.unknownModelPolicy.refuse": "가격 설정 후 실행",
  "modelAdmin.discoverHint": "모델 조회를 실행하면 Provider의 모델을 볼 수 있습니다. 저장된 선택 모델은 바로 표시합니다.",
  "models.selectedOnly": "선택한 Models만 보기",
  "modelAdmin.chooseType": "Model 유형 선택",
  "modelAdmin.manualHint": "모델 ID를 바로 등록합니다. 한도·기능·가격은 등록 모델 관리에서 수정할 수 있습니다.",
  "modelAdmin.unsupportedType": "지원하지 않는 출력 유형입니다.",
  "modelAdmin.factsHint": "공개 Provider의 모델과 가격은 models.opspresso.com에서, 내부 self-hosted 모델은 해당 엔드포인트에서 조회합니다. 오프라인에서는 내장 카탈로그를 사용합니다.",
  ...
  "models.column.capabilities": "역량",
  "models.column.pricing": "가격·컨텍스트",
  "models.column.actions": "동작",
  "models.sort.name": "이름순",
  "models.sort.price": "가격순",
  "models.sortPriceHint": "Text는 출력 토큰, Embedding·Decision은 입력 토큰 가격을 기준으로 정렬합니다. 이미지·오디오·Rerank는 제공된 단위 가격을 사용하며, 가격 미지정 모델은 마지막에 표시합니다.",
  "modelAdmin.emptyModels": "선택한 Model이 없습니다. Model을 조회하거나 Self-hosted Model을 등록하세요.",
  "modelAdmin.default": "기본 Model",
  "modelAdmin.confirmModel": "Model 확인",
  "modelAdmin.discoveryEmpty": "이 연결의 Model 목록이 비어 있습니다. 내부 Self-hosted Model은 직접 등록할 수 있습니다.",
  ...
  "modelAdmin.catalogPrice": "이 모델의 요금은 공개 카탈로그에서 갱신합니다. 다른 설정은 여기서 수정할 수 있습니다.",
  "modelAdmin.check": "상태 확인",
  "modelAdmin.available": "목록에 있음",
  "modelAdmin.missing": "목록에 없음",
  "modelAdmin.deleteModel": "Model을 삭제할까요?",
  "modelAdmin.deleteModelHint": "이 Model을 사용하는 새 실행이 거부됩니다. 삭제 전에 사용 설정을 변경하세요.",
  "modelAdmin.onlySelected": "관리자가 선택한 Model만 이 설치에서 사용할 수 있습니다.",
  ...
  "workspace.runtimeModelsLink": "Settings → Models → Model 사용 설정에서 Workspace 런타임 모델 선택",
  "workspace.runtimeModelsAskAdmin": "관리자에게 Settings → Models → Model 사용 설정에서 Workspace 런타임 모델을 선택해 달라고 요청하세요.",
  ...
  "nav.group.workspace": "작업",
  "nav.group.intelligence": "구성 요소",
  "nav.group.system": "관리",
  "nav.overview": "개요",
  "nav.chats": "Chats",
  ...
  "home.eyebrow": "사내 Agent 운영 · 단일 설치",
  "home.headline": "사내 모델과 도구를 Agent로 연결하고,",
  "home.headlineAccent": "실행 결과까지 확인하세요.",
  "home.lede": "조직의 네트워크 안에서 Agent를 구성하고 실행하세요. 설정, 대화, 실행 트레이스와 사용량을 한곳에서 관리합니다.",
  "home.signInHint": "허용된 도메인의 계정으로 로그인하세요.",
  "home.flow.title": "Agent가 움직이는 경로",
  "home.flow.build": "구성",
  "home.flow.buildBody": "등록된 모델을 선택하고 지시문을 작성한 뒤 필요한 Skill과 도구를 연결합니다.",
  "home.flow.run": "실행",
  "home.flow.runBody": "Chat, API 또는 연결된 메신저에서 Agent를 사용합니다.",
  "home.flow.review": "검토",
  "home.flow.reviewBody": "응답, 결과 파일, 트레이스와 모델 사용량을 확인합니다. Workspace 변경은 게시 전에 검토합니다.",
  "home.sectionLabel": "사내망을 위한 설계",
  "home.coverage": "설정부터 결과의 근거까지",
  "home.coverageBody": "작업의 각 단계를 분리해 결과와 그 과정에서 내린 결정을 확인할 수 있습니다.",
  "home.benefit.network": "사내망에서 동작",
  "home.benefit.networkBody": "부팅, 로그인, 실행과 콘솔은 공개 인터넷 없이 내부 서비스를 이용하도록 구성할 수 있습니다.",
  "home.benefit.control": "역량과 실행 경계",
  "home.benefit.controlBody": "배포에서 사용할 모델을 선택하고 Agent별 도구를 연결하며 필요한 실행 한도를 설정합니다.",
  "home.benefit.evidence": "확인할 수 있는 결과",
  "home.benefit.evidenceBody": "대화, 파일, 트레이스와 사용량을 따라 Agent가 무엇을 만들고 사용했는지 확인합니다.",
  "catalog.clearSearch": "검색어 지우기",
  "catalog.view": "목록 표시 방식",
  "catalog.view.list": "행",
  "catalog.view.grid": "그리드",
  ...
  "routing.globalHint": "자동 라우팅을 켠 모든 Agent가 사용할 tier 모델을 한 번 배정합니다. 주 모델은 유지합니다. 결정 모델은 위에서 선택하고, 작업별 정책과 한도는 고급 설정에서 관리합니다.",
  "routing.advanced": "라우팅 고급 설정",
  "routing.sharedHint": "전역 라우팅 정책을 사용합니다. 모델 배정·예산·승격 규칙은 모델 사용 설정에서 관리합니다.",
  "routing.noSharedModels": "전역 tier 모델이 배정되지 않아 이 Agent의 주 모델을 사용합니다.",
  "routing.manageShared": "전역 라우팅 설정 보기",
  ...
  "routing.policies": "작업별 정책 (Jev보다 우선 적용)",
  "routing.tier.fast": "빠른 모델",
  "routing.tier.general": "일반 모델",
  "routing.tier.coding": "코딩 모델",
  "routing.tier.reasoning": "추론 모델",
  "routing.tier.vision": "이미지 이해 모델",
  "routing.purpose.summary": "요약",
  "routing.purpose.classification": "분류",
  ...
  "routing.qualityHint": "비어 있거나 짧은 답변, 잘린 답변과 잘못된 분류 JSON은 즉시 승격합니다. 호출이 두 번 실패하면 승격하며, 주 모델 fallback을 포함하여 최대 네 번 시도합니다. 출력 구조를 검사하며 사실 정확성을 보장하지는 않습니다.",
  ...
  "guide.api.sdkBody":
    "API Reference의 Python 또는 JavaScript 예제로 chat/completions를 호출한다. SDK base URL은 Agent 주소, API key는 Agent 토큰으로 설정한다. 모델과 샘플링 파라미터는 저장한 Agent 설정이 결정하며 model·temperature·max_tokens로 덮어쓰지 않는다. 예제를 실행하기 전에 호출 프로세스의 환경변수 AGENT_API_TOKEN과 CONVERSATION_ID를 설정한다.",
  ...
  "chat.pickAgent": "Agent를 고르고 첫 메시지를 보내세요.",
  "chat.welcomeTitle": "새 Chat",
  ...
  "chat.agent": "Agent",
  "chat.noAgentSummarys": "Agent가 없습니다",
  ...
  "agents.lede": "Agent를 설정하고 도구를 연결해 요청을 실행합니다.",
  "agents.new": "새 Agent",
  ...
  "agent.lede": "이 Agent를 한 Workspace에서 설계하고, 시험하고, 관찰합니다.",
  "agent.ownedBy": "소유자: ",
  "agent.clone": "복제",
  "agent.cloneTitle": "{name} 복제",
  ...
  "agent.tab.integrations": "연동",
  "agent.tab.settings": "설정",
  ...
  "preview.request": "요청",
  "preview.requestHint":
    "Memory recall과 capability 매칭에 사용합니다. 미리보기를 만들면 설정된 MCP와 embedding/rerank 서비스에 이 요청을 전송합니다. 실제 요청으로 실행이 받을 문맥과 기능을 확인하고, 비워 두면 공통 시작 상태를 볼 수 있습니다.",
  ...
  "skills.attachmentsCount": "첨부 파일 {count}개",
  ...
  "models.selection.lede":
    "케이퍼빌리티 embedding과 2차 reranking에 사용할 등록 Model을 선택합니다. 선택한 Model의 프로바이더 연결을 사용합니다.",
  ...
  "models.selection.rerankerMinScore": "최소 관련성 점수",
  "models.selection.rerankerMinScoreHint": "선택한 Rerank 모델에 맞춰 조정합니다(0–1).",
  "models.selection.catalogMinScore": "최소 벡터 점수",
  "models.selection.catalogMinScoreHint": "선택한 Embedding Model에 맞춰 조정합니다(0–1).",
  "models.selection.saveScore": "점수 저장",
  ...
  "apiRef.request": "요청",
  "apiRef.response": "응답",
  "agentArtifacts.empty": "이 Agent는 아직 만들어 낸 것이 없습니다.",
  ...
  "agentUsage.topCallersRange": "선택한 기간에 비용을 많이 쓴 호출자 {count}명",
  "agentUsage.caller": "호출자",
