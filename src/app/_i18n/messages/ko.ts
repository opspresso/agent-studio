...
export const ko: Messages = {
  ...
  "workspace.policy.modeHint.selected": "기본 저장소와 등록한 저장소만 허용합니다. 기본값과 목록을 모두 비우면 Git 접근이 차단됩니다.",
  "workspace.policy.modeHint.owners": "기본·등록 저장소와 지정한 계정·조직이 소유한 모든 저장소를 허용합니다.",
  ...
  "workspace.policy.override": "Studio에서 관리",
  "workspace.policy.deployment": "배포 기본값",
  "workspace.policy.description": "관리자가 이 프로젝트의 Workspace에서 사용할 저장소를 관리합니다. 저장한 규칙은 앱·worker 재배포 없이 새 작업과 Git 승인에 적용됩니다.",
  "workspace.policy.adminOnly": "저장소 접근은 관리자만 변경할 수 있습니다. 관리자에게 이 페이지를 전달하세요.",
  "workspace.policy.defaultRepository": "기본 저장소 (선택)",
  "workspace.policy.defaultHint": "기본 저장소도 허용됩니다. owner/repository 형식으로 입력하고, 기본값이 필요 없으면 비워 두세요.",
  "workspace.policy.repositories": "추가 허용 저장소",
  ...
  "workspace.policy.scopeHint": "모든 모드에서 GitHub 계정 권한과 개별 Git 승인은 계속 적용됩니다. 기본값 복원은 모드와 목록을 배포 설정으로 교체합니다. 이미 실행 중인 작업은 별도로 취소해야 합니다.",
  "workspace.policy.save": "저장소 접근 저장",
  "workspace.policy.reset": "배포 기본값 복원",
  ...
  "guide.workspaces.repositoryBody": "생성 전에 정확한 owner/name을 확인한다. 관리자는 Project Settings에서 저장소 고정·소유자 지정·모든 저장소·등록 목록 + 신규 자동 허용을 선택한다. 신규 모드에서는 Agent가 Workspace create_repository로 생성·초기화하면 자동 등록된다. 이미 존재하는 미등록 저장소는 관리자 등록이 필요하다. 반환된 기준 브랜치를 검사한 뒤 파일 작업을 시작한다. Git 작업에는 저장소와 브랜치를 함께 지정하며 나중에 Git을 연결하려면 workdir가 비어 있어야 한다.",
