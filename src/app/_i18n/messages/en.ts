...
export const en = {
  ...
  "workspace.policy.scopeHint": "GitHub account permissions and individual Git approvals still apply. Empty rules disable Git work. Deployment defaults replace these rules when restored. Already running tasks require a separate cancellation.",
  ...
  "guide.workspaces.repositoryBody": "Before creating a repository, check its exact owner/name against Workspace repository access. Administrators manage repositories and allowed owners in Project Settings or Settings; an allowed owner includes its future repositories. If blocked, follow the returned management link before creating anything. Once allowed, create and initialize the requested repository, then verify the Workspace GitHub account and base branch. Select repository and base branch together for Git work; selecting neither creates a Git-free Workspace. Attaching Git later requires an empty workdir.",
