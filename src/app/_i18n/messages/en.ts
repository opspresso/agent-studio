...
export const en = {
  ...
  "workspace.policy.modeHint.selected": "Only the default and listed repositories are allowed. An empty list with no default disables Git access.",
  "workspace.policy.modeHint.owners": "Allow the default and listed repositories, plus every repository owned by the selected accounts or organizations.",
  ...
  "workspace.policy.override": "Managed in Studio",
  "workspace.policy.deployment": "Deployment defaults",
  "workspace.policy.description": "Administrators manage the repositories this project can use in Workspaces. Saved rules take effect for new work and Git approvals without redeploying the app or workers.",
  "workspace.policy.adminOnly": "Only an administrator can change repository access. Share this page with your administrator.",
  "workspace.policy.defaultRepository": "Default repository (optional)",
  "workspace.policy.defaultHint": "The default is also allowed. Use owner/repository; leave empty for no default.",
  "workspace.policy.repositories": "Additional allowed repositories",
  ...
  "workspace.policy.scopeHint": "GitHub account permissions and individual Git approvals still apply in every mode. Restoring deployment defaults replaces the mode and lists. Already running tasks require a separate cancellation.",
  "workspace.policy.save": "Save repository access",
  "workspace.policy.reset": "Restore deployment defaults",
  ...
  "guide.workspaces.repositoryBody": "Check the exact owner/name before creation. Administrators choose fixed repositories, selected owners, all accessible repositories or listed repositories plus new ones in Project Settings. In new mode, ask the agent to use Workspace create_repository: it initializes the repository and registers successful creation automatically. An existing unlisted repository still needs administrator registration. Check the returned base branch before starting file work. Select both repository and branch for Git work; attaching Git later requires an empty workdir.",
