...
export const en = {
  ...
  "settings.section.service": "Configure the service address, artifact access and model pricing policy.",
  ...
  "settings.field.catalogMinScore": "Capability search minimum score",
  "settings.hint.catalogMinScore": "Set the absolute vector score floor from 0 to 1. Recheck it when the embedding model changes.",
  ...
  "settings.group.execution": "Execution and search",
  ...
  "guide.admin.settingsBody": "Settings groups Service, Access, Plugins and Models. Service manages branding, public addresses, artifact delivery, search and execution policies, and Slack progress text. Access manages administrators and allowed domains. Plugins manages its GitHub repository and token; Models manages provider connections and selected models. Only changed fields are saved. Deployment settings still own the database, encryption, sign-in providers, storage connections and retention.",
