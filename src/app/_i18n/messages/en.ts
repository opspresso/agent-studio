...
export const en = {
  ...
  "settings.overview": "Manage application settings, plugins, models and access keys.",
  ...
  "modelAdmin.selectionHint": "Discover available models and choose which models this installation can use.",
  "modelAdmin.usage": "Model usage",
  "modelAdmin.usageHint": "Choose the default model, Workspace runtime models and active search models.",
  ...
  "models.sortPriceHint": "Output token price for text; input token price for embeddings and decisions; per-image, audio-minute or rerank price when provided. Unknown prices are last.",
  ...
  "modelAdmin.discoveryEmpty": "The provider returned no models. You can register a model manually.",
  ...
  "modelAdmin.available": "Available",
  "modelAdmin.missing": "Not listed by provider",
  ...
  "workspace.runtimeModelsLink": "Select Workspace runtime models in Models",
