...
export const en = {
  ...
  "routing.globalHint": "Assign tier models once for all Agents that enable automatic routing. The main model remains unchanged. Select the decision model above; task policies and limits are under Advanced settings.",
  ...
  "routing.qualityHint": "Empty, short or truncated answers and invalid classification JSON trigger promotion. Two failures trigger promotion; at most four attempts include the main-model fallback. This checks output structure, not factual accuracy.",
