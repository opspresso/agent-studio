...
export const en = {
  ...
  "audio.pageHint": "Upload audio and follow transcription or Agent processing in the background.",
  ...
  "audio.personalOnly": "Saved to your personal scope. Processing continues after you leave.",
