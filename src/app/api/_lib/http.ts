 ...
 *
 * A typed 5xx answers with its own message and is logged too; surfacing detail to
 * the caller must not remove the server-side record operators need later.
 *
 ...
 * nobody is there to read it, and one `info` line names the abandoned request.
 */
