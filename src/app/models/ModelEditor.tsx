...
import { REGISTRY_MODEL_TYPES, registrationFromDiscovery, type RegistryModelType } from "@/domain/llm/providerModels";
...
export function ModelEditor({ model, onSaved, onCancel }: {
  model: RegisteredModelView;
  onSaved(models: RegisteredModelView[]): void;
  onCancel(): void;
}) {
  const t = useT();
