...
// --- Header overrides -------------------------------------------------------
// A Agent may redefine a registry server's headers. Overrides carry the same
 ...
 * with a Agent's overrides layered on. HTTP header names are case-insensitive,
 ...
 * that take a Agent from a form must still resolve masks against the stored
